        ...
        <div class="container mx-auto">
            <div class="flex flex-col items-center text-center">
                ...
                <p class="subtitle">
                    ...
                    Itaque sunt nesciunt animi nostrum maxime sapiente inventore
                    sit enim natus accusantium, eveniet dignissimos, incidunt
                    dicta harum perspiciatis. Quam ullam quis provident?
                </p>
            </div>
                ...
                >
                    ...
                    <div class="flex flex-col lg:flex-row gap-x-4">
                        ...
                        <div>
                            ...
                            <p class="mb-1 text-paragraph">Aizawl, Mizoram</p>
                            <p class="text-accent font-normal">
