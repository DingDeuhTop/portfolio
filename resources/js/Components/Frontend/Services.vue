        ...
        <div class="container mx-auto">
            <div class="flex flex-col items-center text-center">
                ...
                <p class="subtitle">
                    ...
                    Velit saepe possimus nobis culpa repellat repudiandae
                    reiciendis quod aspernatur veniam? Autem voluptates
                    repellendus officia deserunt pariatur possimus harum
                    laudantium adipisci odio.
                </p>
            </div>
            <div class="grid lg:grid-cols-4 gap-8">
                ...
                >
                    ...
                    <h4 class="text-xl font-mediummb-2">Web Design</h4>
                </div>
                <div
                    class="bg-light-tail-100 dark:bg-dark-navy-500 p-6 rounded-2xl"
                >
